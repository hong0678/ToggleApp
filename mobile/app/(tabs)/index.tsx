      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.topBar}>
          <View style={styles.logoContainer}>
            <Image source={require('@/assets/images/mainLogo.png')} style={{ width: 34, height: 34, resizeMode: 'contain', marginRight: 10 }} />
            <Text style={{ color: '#dbeafe', fontSize: 26, fontWeight: '800', letterSpacing: -0.5 }}>Toggle</Text>
          </View>
        ...
        <View style={styles.content}>
          ...
          {/* Action Buttons */}
          <Link href="/views/map_around" asChild>
          ...
          <Link href="/views/map_search" asChild>
